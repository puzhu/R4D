...
Another alternative is to pick from a few [preconfigured themes](https://www.r-graph-gallery.com/192-ggplot-themes/) that ship with gggplot2. Lets try the minimal theme.
